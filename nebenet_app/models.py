...
class Product(models.Model):
    ...
    pro_description = models.TextField('Descrizione',max_length=3000, blank=False)
    pro_characteristics =  models.TextField('Caratteristiche',max_length=3000, blank=False)
...
class Ticket(models.Model):
    ...
    Problema = models.TextField('Descrivi il tuo problema*',max_length=1000, blank=False)
